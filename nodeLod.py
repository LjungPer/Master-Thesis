...
class nodeCorrector:
    def __init__(self, world, k, iNodeWorldCoarse, saddleSolver=None):
        self.k = k
        ...
        iPatchWorldCoarse = np.maximum(0, iNodeWorldCoarse - k - 1).astype('int64')
        iEndPatchWorldCoarse = np.minimum(NWorldCoarse - 1, iNodeWorldCoarse + k).astype('int64') + 1
